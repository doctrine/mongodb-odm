...
class_exists(\Doctrine\ODM\MongoDB\Mapping\Attribute\Document::class);

return;

/**
 * Identifies a final class as a document that can be stored in the database
 *
...
final class Document extends \Doctrine\ODM\MongoDB\Mapping\Attribute\Document
{
}

...
class_exists(\Doctrine\ODM\MongoDB\Mapping\Attribute\File\ChunkSize::class);
...
final class ChunkSize extends \Doctrine\ODM\MongoDB\Mapping\Attribute\File\ChunkSize
{
}

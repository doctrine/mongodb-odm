...
class_exists(\Doctrine\ODM\MongoDB\Mapping\Attribute\InheritanceType::class);
...
final class InheritanceType extends \Doctrine\ODM\MongoDB\Mapping\Attribute\InheritanceType
{
}

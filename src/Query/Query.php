...
{
    public const int TYPE_FIND            = 1;
    public const int TYPE_FIND_AND_UPDATE = 2;
    public const int TYPE_FIND_AND_REMOVE = 3;
    public const int TYPE_INSERT          = 4;
    public const int TYPE_UPDATE          = 5;
    public const int TYPE_REMOVE          = 6;
    public const int TYPE_DISTINCT        = 9;
    public const int TYPE_COUNT           = 11;

    // 2 was used for HINT_SLAVE_OKAY, which was removed in 2.0
    public const int HINT_REFRESH         = 1;
    public const int HINT_READ_PREFERENCE = 3;
    public const int HINT_READ_ONLY       = 5;
    ...
    /**
     * @param QueryShape                        $query   Query structure generated by the Builder class.

...
class AttributeDriverTest extends AbstractMappingDriverTestCase
{
    public function testFieldInheritance(): void
    {
        // @TODO: This can be a generic test for all drivers
        $super  = $this->dm->getClassMetadata(AttributeDriverTestSuper::class);
        $parent = $this->dm->getClassMetadata(AttributeDriverTestParent::class);
        $child  = $this->dm->getClassMetadata(AttributeDriverTestChild::class);
        ...
        self::assertEquals(AttributeDriverTestSuper::class, $parent->fieldMappings['private']['declared'], 'Non-inherited private field from MappedSuperclass parent is declared in MappedSuperclass parent');
        ...
        self::assertEquals(AttributeDriverTestParent::class, $child->fieldMappings['id']['declared'], 'Inherited public field from MappedSuperclass grandparent is declared in Document parent');
        self::assertEquals(AttributeDriverTestParent::class, $child->fieldMappings['protected']['declared'], 'Inherited protected field from MappedSuperclass grandparent is declared in Document parent');
        self::assertEquals(AttributeDriverTestSuper::class, $child->fieldMappings['private']['declared'], 'Inherited private field from MappedSuperclass grandparent is declared in MappedSuperclass grandparent');
        self::assertEquals(AttributeDriverTestParent::class, $child->fieldMappings['foo']['declared'], 'Inherited public field from Document parent is declared in Document parent');
    }

    public function testLoadMetadataForNonDocumentThrowsException(): void
    {
        $cm              = new ClassMetadata('stdClass');
        $attributeDriver = static::loadDriver();
    ...
    public function testColumnWithMissingTypeDefaultsToString(): void
    {
        ...
        $attributeDriver->loadMetadataForClass(stdClass::class, $cm);
    ...
    public function testGetAllClassNamesReturnsAlreadyLoadedClassesIfAppropriate(): void
    {
        ...
        $attributeDriver = $this->loadDriverForCMSDocuments();
        $classes         = $attributeDriver->getAllClassNames();
    ...
    public function testEmbeddedClassCantHaveShardKey(): void
    {
        ...
        $this->dm->getClassMetadata(AttributeDriverEmbeddedWithShardKey::class);
    }

    public function testDocumentAttributeCanSpecifyWriteConcern(): void
    {
        $cm = $this->dm->getClassMetadata(AttributeDriverTestWriteConcernMajority::class);
        self::assertSame('majority', $cm->writeConcern);

        $cm = $this->dm->getClassMetadata(AttributeDriverTestWriteConcernUnacknowledged::class);
    ...
    protected static function loadDriver(array $paths = []): AttributeDriver
    {
    ...
    protected function loadDriverForCMSDocuments(): AttributeDriver
    {
        return static::loadDriver([__DIR__ . '/../../Documents']);
    }
}
...
#[ODM\MappedSuperclass]
class AttributeDriverTestSuper
{
    /** @var string|null */
    #[ODM\Id]
    public $id;
...
#[ODM\Document]
class AttributeDriverTestParent extends AttributeDriverTestSuper
{
    /** @var string|null */
    #[ODM\Field(type: 'string')]
    public $foo;
...
#[ODM\Document]
class AttributeDriverTestChild extends AttributeDriverTestParent
{
    /** @var string|null */
    #[ODM\Field(type: 'string')]
    public $bar;
...
class AttributeDriverEmbeddedWithShardKey
{
    /** @var string|null */
    #[ODM\Field(type: 'string')]
    public $foo;
...
class AttributeDriverTestWriteConcernMajority
{
    /** @var string|null */
    #[ODM\Id]
    public $id;
...
class AttributeDriverTestWriteConcernUnacknowledged
{
    /** @var string|null */
    #[ODM\Id]
    public $id;
